...
/**
 * The SettingsActivity class represents the settings screen of the application.
 * It allows users to configure various settings and handles bottom navigation.
 */
